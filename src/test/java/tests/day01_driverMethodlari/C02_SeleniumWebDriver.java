...
public class C02_SeleniumWebDriver {
    ...
    public static void main(String[] args) {
        ...
        // ilk adimi atlayip direkt WebDriver objesi olusturalim
        ...
        /*
            ...
            Sadece oncelikle bizden bir driver bekledigi icin birazcik gec calisiyor

            AMA Sirketler acik kaynakli driver kullanmayi tercih etmez
